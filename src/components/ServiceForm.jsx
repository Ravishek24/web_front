...
export default function ServiceForm({ onClose }) {
  ...
  return (
    <div className="w-full max-w-2xl bg-white rounded-3xl shadow-2xl overflow-hidden glass-card max-h-[90vh] overflow-y-auto">
      ...
      >
        <div>
          <h2 className="text-lg sm:text-xl font-bold">Create Service Listing</h2>
          <p className="text-[11px] sm:text-xs text-white/90 font-medium">
            Share your service with the community
          </p>
        </div>
        <button
          type="button"
      ...
      <form onSubmit={handleSubmit} className="px-4 sm:px-6 py-4 sm:py-5 space-y-4">
        ...
        <div>
          ...
          <textarea
            ...
            onChange={handleChange}
            rows={4}
            className="w-full px-3 py-2 rounded-xl border border-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent text-sm resize-none"
